...
syn keyword objectScriptReserved	const debugger double enum export extends final float goto
syn keyword objectScriptReserved	implements import int interface long native package private
syn keyword objectScriptReserved	protected finally public short static super synchronized
syn keyword objectScriptReserved	throws transient volatile 
...
if version >= 508 || !exists("did_javascript_syn_inits")
  ...
  HiLink objectScriptError		Error
  HiLink javaScrParenError		objectScriptError
