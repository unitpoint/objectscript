...
"c:\Program Files\Emscripten\emscripten\1.13.0\em++.bat" -DOS_EMSCRIPTEN -DOS_NUMBER_NAN_TRICK_DISABLED -I..\..\src\ -Oz --closure 1 -s OUTLINING_LIMIT=1000000 -s DISABLE_EXCEPTION_CATCHING=1 -s NO_EXIT_RUNTIME=1 -s EXPORTED_FUNCTIONS="['_OS_create', '_OS_eval','_OS_release']" -Wswitch-enum --memory-init-file 0 -o os-vm-js.html ..\..\os.cpp ..\..\src\objectscript.cpp ..\..\src\os-heap.cpp 